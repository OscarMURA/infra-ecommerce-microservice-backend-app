# Variables para ambiente staging - GKE
...
variable "regional" {
  description = "Cluster regional (recomendado para staging)"
  type        = bool
  default     = false
}
...
variable "cluster_name" {
  ...
  type        = string
  default     = "ecommerce-staging-gke-v2"
}
...
# Node Pool - Configuración intermedia
...
variable "node_tags" {
  ...
  type        = list(string)
  default     = ["gke-node", "ecommerce", "staging"]
}
